...
class ProtoObjectStream {
     ...
     */
    static createObjectToBufferStream() {
     ...
     */
    static createBufferToObjectStream(objectClass) {
        return new node_stream_1.Transform({
            objectMode: true,
     ...
     */
    static createSerializationPipeline(objectClass) {
        return {
            serialize: this.createObjectToBufferStream(),
            deserialize: this.createBufferToObjectStream(objectClass),
        };
    }
    /**
     ...
     */
    static createBidirectionalStream(objectClass) {
        return new node_stream_1.Transform({
            objectMode: true,
            transform(chunk, encoding, callback) {
                try {
...
exports.ProtoObjectStream = ProtoObjectStream;
